...
class JointAutoregressiveHierarchicalPriors(CompressionModel):
    ...
    def forward(self, x):
        ...
        print(f"ctx_params shape after context_prediction: {ctx_params.shape}")
        print(f"params shape: {params.shape}, ctx_params shape: {ctx_params.shape}")
    ...
    def compress(self, x):
        ...
        params = self.h_s(z_hat)
        print(f"params shape after h_s: {params.shape}")
